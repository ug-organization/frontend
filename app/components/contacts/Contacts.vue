    ...
    <div class="container">
      ...
      <div class="contacts__grid">
        ...
        <div class="contacts__card">
          ...
          <span class="contacts__card-subtitle"
            >Работаем по всей России. БЕСПЛАТНАЯ ДОСТАВКА ДО ВАШЕГО
            ОБЪЕКТА</span
          >
        </div>
        ...
        <div class="contacts__card">
          <div class="contacts__card-icon-2">
            <img src="/img/telegram-con.png" alt="img" />
          </div>
        ...
        <div class="contacts__card">
          <div class="contacts__card-icon-2">
            <img src="/img/whatsapp-con.png" alt="img" />
          </div>
